...
import {initCheck} from "@/hooks/DataManager";
...
CREATE TABLE IF NOT EXISTS "typeOfMaintains" (
	"id"	TEXT NOT NULL UNIQUE,
	"name"	TEXT NOT NULL UNIQUE,
	"swr"	TEXT NOT NULL,
	PRIMARY KEY("id")
...
CREATE TABLE IF NOT EXISTS "eventsMaintains" (
  "id"	TEXT NOT NULL UNIQUE,
	...
	"idMaintainType"	TEXT NOT NULL,
  PRIMARY KEY("id"),
  FOREIGN KEY("idMaintainType") REFERENCES "typeOfMaintains"("id"),
	FOREIGN KEY("idSkis") REFERENCES "itemsSkis"("id")
);
...
CREATE TABLE IF NOT EXISTS "joinSkisUsers" (
    ...
    await db.execAsync(`
INSERT INTO "typeOfMaintains" VALUES ('init-1','Affutage','2');
INSERT INTO "typeOfMaintains" VALUES ('init-2','Fartage','3');
INSERT INTO "typeOfMaintains" VALUES ('init-3','Réparation','5');
INSERT INTO "typeOfMaintains" VALUES ('init-4','Entretien de fin de saison','6');
INSERT INTO "typeOfMaintains" VALUES ('init-5','Mise à plat - Magasin','30');
